...
#nullable enable
        public static async void Init()
        {
            ...
            {
                LogManager.Info($"You are using UncomplicatedSettingsFramework v{VersionInfo.Name}{(VersionInfo.CustomName is not null ? $" '{VersionInfo.CustomName}'" : string.Empty)}!");
            }
